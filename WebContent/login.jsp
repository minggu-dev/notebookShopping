...
<body>
	...
	<div class="home">
		<div class="container-login100">
			<div class="wrap-login100 p-l-85 p-r-85 p-t-55 p-b-55">
				<form action="note?command=userLogin" method="post"
					class="login100-form validate-form flex-sb flex-w">
					<span class="login100-form-title p-b-32"> 로그인하는곳 </span> <span
					...
					<div class="flex-sb-m w-full p-b-48">
						...
						<div>
							<a href="findById.jsp" class="txt3"> 아이디 찾기 </a>
					...
					<div class="container-login100-form-btn">
						<input type="submit" name="login" class="login100-form-btn"
							value="로그인">
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input
							type="button" name="register" class="login100-form-btn"
							value="회원가입">
					</div>
	...
	$(function() {
		$("input[name=register]").click(function() {
			location.href = "note?command=questionAll";
		});
