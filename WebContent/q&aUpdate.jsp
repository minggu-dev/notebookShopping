...
<div id= "contentForm">
    <input type="hidden" name="pageNum" value="${pageNum}">
        ...
        <table class="table table-striped table-bordered">
          <thead>
            ...
            <tr>
              ...
              <td><input type="text" name="title" size="70" value="${article.title}"
                    ></td>
            </tr>
          </thead>
          <tbody>
            <tr>
              <td colspan="2">
                <textarea cols="210" rows="20" name="content" >${article.content}</textarea>
              </td>
            </tr>
            <tr>
      ...
      <div class="btn-group btn-group-sm" role="group" aria-label="...">
        ...
        <input type="button" class="btn btn-default" value="취소" onclick="document.location.href='list.jsp?articleNumber=${articleNumber}&pageNum=${pageNum}'">
      </div>
    </div>
  </form>
