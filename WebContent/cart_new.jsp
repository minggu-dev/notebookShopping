				...
				<div class="row">
					<div class="col">
						<div class="header_content d-flex flex-row align-items-center justify-content-start">
							<div class="logo"><a href="index.jsp">노트북 쇼핑</a></div>
							<nav class="main_nav">
								<ul>
									<li>
            ...
            <div class="row">
				...
				<div class="col">
					<div class="cart_buttons d-flex flex-lg-row flex-column align-items-start justify-content-start">
						<div class="button continue_shopping_button"><a href="index.html">Continue shopping</a></div>
							...
							<label class="delivery_option clearfix">기본배송지
								...
								<div>
									 ...
									 <p class="heading"> <input type="radio" name="addr">신규배송지</p>
									  <div class="content">받을 배송지를 적어주세요<br>
									  <br>				  
					...
					<div class="cart_total">
						...
						<div class="cart_total_container">
							<ul>
								...
								<li class="d-flex flex-row align-items-center justify-content-start">
									<div class="cart_total_title">Qty</div>
									<div class="cart_total_value ml-auto">1</div>
								</li>
								<li class="d-flex flex-row align-items-center justify-content-start">
